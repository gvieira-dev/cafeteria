...
const appCss = "/cafeteria/assets/styles-ByqAflYI.css";
...
const $$splitComponentImporter$3 = () => import("./visite-6ETFhwS4.js");
const Route$3 = createFileRoute("/visite")({
  head: () => ({
    meta: [{
      title: "Visite — Casa Colombo · Av. Norival Guilherme Viêira, 129"
    }, {
      name: "description",
      content: "Estamos no Ibituruna, em Montes Claros · MG. Veja horários, telefone, rota e tudo que você precisa para visitar a Casa Colombo."
    }, {
      property: "og:title",
      content: "Visite a Casa Colombo"
    }, {
      property: "og:description",
      content: "Av. Norival Guilherme Viêira, 129 — Ibituruna, Montes Claros · MG."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const interior = "/cafeteria/assets/interior-corner-CMvwTmHm.jpg";
const $$splitComponentImporter$2 = () => import("./sobre-D8JdS0Ub.js");
const Route$2 = createFileRoute("/sobre")({
  head: () => ({
    meta: [{
      title: "Sobre — Casa Colombo Cafeteria"
    }, {
      name: "description",
      content: "Conheça a história da Casa Colombo: uma cafeteria afetiva no Ibituruna, em Montes Claros, com receitas feitas à mão e cuidado em cada detalhe."
    }, {
      property: "og:title",
      content: "Sobre a Casa Colombo"
    }, {
      property: "og:description",
      content: "Uma cafeteria afetiva em Montes Claros · MG."
    }, {
      property: "og:image",
      content: interior
    }]
...
const $$splitComponentImporter$1 = () => import("./cardapio-BqDHGMS2.js");
const Route$1 = createFileRoute("/cardapio")({
  head: () => ({
    meta: [{
      title: "Cardápio — Casa Colombo Cafeteria"
    }, {
      name: "description",
      content: "Croissants, bolos afetivos, quiches, cafés especiais V60, espresso e drinks autorais. Conheça os destaques do cardápio da Casa Colombo."
    }, {
      property: "og:title",
      content: "Cardápio Casa Colombo"
    }, {
      property: "og:description",
      content: "Croissants, bolos, quiches e cafés especiais."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-FIJk1YRr.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Cafeteria especial no Ibituruna com croissants artesanais, bolos, café coado V60 e atmosfera acolhedora. Av. Norival Guilherme Viêira, 129 — Montes Claros · MG."
    }, {
      property: "og:title",
      content: "Casa Colombo · Cafeteria · Montes Claros"
    }, {
      property: "og:description",
      content: "Café especial, doces afetivos e um espaço pra ficar."
    }, {
      property: "og:type",
      content: "website"
    }]
...
const VisiteRoute = Route$3.update({
  id: "/visite",
  path: "/visite",
  getParentRoute: () => Route$4
});
const SobreRoute = Route$2.update({
  id: "/sobre",
  path: "/sobre",
  getParentRoute: () => Route$4
});
const CardapioRoute = Route$1.update({
  id: "/cardapio",
  path: "/cardapio",
  getParentRoute: () => Route$4
});
