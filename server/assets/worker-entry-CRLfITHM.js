...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-4tIuyhxs.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bb06X24e.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "cafeteria";
var SERVER_FN_BASE = "/cafeteria/_serverFn/";
